...
function WidthProvider(ComposedComponent) {
  ...
  return _temp2 = _class = function (_React$Component) {
    ...
    function WidthProvider() {
      ...
      _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
        width: 1280
      ...
      // console.log('@@@ WidthProvider constructor', _ret, this.props);
      return _ret;
    }

    WidthProvider.prototype.componentWillMount = function componentWillMount() {
      console.log('@@@ WidthProvider componentWillMount', this, this.props);
    };
