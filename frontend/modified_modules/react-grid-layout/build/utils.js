...
function compact(layout, compactType, cols) {
  ...
  // console.log('--- sorted', sorted, compareWith);
...
function compactItem(compareWith, l, compactType, cols, fullLayout) {
  ...
  if (compactV) {
    // console.log('     in compactItem l', l, 'compareWith', compareWith)
  ...
  while (collides = getFirstCollision(compareWith, l)) {
    // console.log('------@@@@@@@@ collides', collides, 'l', l, 'compareWith', compareWith, 'compactH', compactH, 'fullLayout', fullLayout);
    if (compactH) {
...
function correctBounds(layout, bounds) {
  ...
  // console.log(' --- layout in correctBounds', layout);
  for (var _i5 = 0, len = layout.length; _i5 < len; _i5++) {
    ...
    if (!l.static) collidesWith.push(l);
      ...
      // console.log('    in correctBounds l', l, 'collidesWith', collidesWith)
...
function getFirstCollision(layout, layoutItem) {
  for (var _i7 = 0, len = layout.length; _i7 < len; _i7++) {
    ...
    // const layoutItemObj = Array.from(layoutItem)
    // console.log('     in getFirstCollision: JSON.stringify(layout)=', JSON.stringify(layout));
    // console.log('        getFirstCollision 2: JSON.stringify(layoutItem)=', JSON.stringify(layoutItem));
    // console.log('     in getFirstCollision: layoutObj[_i7].y=', layoutObj[_i7].y, '; layoutObj[_i7]=', layoutObj[_i7], '; _i7=', _i7, '//',  layoutObj, layoutItemObj);
...
function moveElement(layout, l, x, y, isUserAction, preventCollision, compactType, cols) {
  ...
  for (var _i8 = 0, len = collisions.length; _i8 < len; _i8++) {
    ...
    if (collision.static) {
      ...
      // console.log('-------moveElementAwayFromCollision layout', JSON.stringify(layout));
      // console.log('       l:', JSON.stringify(l));
      // console.log('       collision:', JSON.stringify(collision), 'isUserAction', isUserAction, 'compactType', compactType, 'cols', cols);
      layout = moveElementAwayFromCollision(layout, l, collision, isUserAction, compactType, cols);
      // console.log('-------after moveElementAwayFromCollision layout', JSON.stringify(layout));
    }
  }
...
function moveElementAwayFromCollision(layout, collidesWith, itemToMove, isUserAction, compactType, cols) {
  ...
  if (isUserAction) {
    ...
    // console.log('    in moveElementAwayFromCollision layout:', JSON.stringify(layout));
    // console.log('        - fakeItem:', JSON.stringify(fakeItem))
...
function synchronizeLayoutWithChildren(initialLayout, children, cols, compactType) {
  ...
  // console.log('---- layout_2', layout);
  layout = compact(layout, compactType, cols);
  // console.log('---- layout_3', layout);
