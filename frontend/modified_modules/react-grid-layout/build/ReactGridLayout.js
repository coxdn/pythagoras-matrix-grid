...
var ReactGridLayout = function (_React$Component) {
  ...
  function ReactGridLayout(props, context) {
    ...
    // console.log('@@@ props in constructor', props, this);
  ...
  ReactGridLayout.prototype.componentDidMount = function componentDidMount() {
    ...
    // console.log('@@@ componentDidMount this.props.layout', this.props, this.state)
    // console.trace()
  ...
  ReactGridLayout.prototype.onLayoutMaybeChanged = function onLayoutMaybeChanged(newLayout, oldLayout) {
    ...
    // console.log('--- onLayoutMaybeChanged', this.props.onLayoutChange);
